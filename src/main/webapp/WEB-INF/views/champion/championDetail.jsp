        ...
        <div class="champion-stats-header">
            <ul class="champion-stats-position">
                <li class="champion-stats-header__position champion-stats-header__position--active"
                    ...
                    <a href="#">
                        ...
                        <img src="//opgg-static.akamaized.net/images/site/champion/position-jun-none@2x.png"
            ...
            <div class="champion-stats-header-info champion-stats-header-info--tier-3">
                <div class="champion-stats-header-info__image">
                    <img src="https://ddragon.leagueoflegends.com/cdn/10.1.1/img/champion/${champion.image.full}">
                    <i></i>
                </div>
            ...
            <div class="champion-stats-header-matchup tabWrap">
                <ul class="champion-stats-header__tab tabHeaders">
                    <li class="champion-stats-header__tab__item tabHeader active"
                        data-tab-show-class="champion-stats-header-matchup__table--strong" data-type="strong">
                        <a href="javascript:;">카운터 챔피언</a>
                    </li>
                    <li class="champion-stats-header__tab__item tabHeader"
                        data-tab-show-class="champion-stats-header-matchup__table--weak" data-type="weak">
                        <a href="javascript:;">상대하기 쉬운 챔피언</a>
                    </li>
                </ul>
                <div class="tabItems">
                    <table class="champion-stats-header-matchup__table champion-stats-header-matchup__table--strong tabItem"
                           style="display: none;">
                        <tbody>
                        <tr data-champion-id="36">
                            <td class="champion-stats-header-matchup__table__champion">
                                <img src="//opgg-static.akamaized.net/images/lol/champion/DrMundo.png?image=q_auto,w_34&amp;v=1576566284"
                                     alt="">문도 박사
                            </td>
                        ...
                        <tr data-champion-id="121">
                            <td class="champion-stats-header-matchup__table__champion">
                                <img src="//opgg-static.akamaized.net/images/lol/champion/Khazix.png?image=q_auto,w_34&amp;v=1576566284"
                                     alt="">카직스
                            </td>
                        ...
                        <tr data-champion-id="32">
                            <td class="champion-stats-header-matchup__table__champion">
                                <img src="//opgg-static.akamaized.net/images/lol/champion/Amumu.png?image=q_auto,w_34&amp;v=1576566284"
                                     alt="">아무무
                            </td>
                    ...
                    <table class="champion-stats-header-matchup__table champion-stats-header-matchup__table--weak tabItem"
                           style="display: none;">
                        <tbody>
                        <tr data-champion-id="246">
                            <td class="champion-stats-header-matchup__table__champion">
                                <img src="//opgg-static.akamaized.net/images/lol/champion/Qiyana.png?image=q_auto,w_34&amp;v=1576566284"
                                     alt="">키아나
                            </td>
                        ...
                        <tr data-champion-id="80">
                            <td class="champion-stats-header-matchup__table__champion">
                                <img src="//opgg-static.akamaized.net/images/lol/champion/Pantheon.png?image=q_auto,w_34&amp;v=1576566284"
                                     alt="">판테온
                            </td>
                        ...
                        <tr data-champion-id="131">
                            <td class="champion-stats-header-matchup__table__champion">
                                <img src="//opgg-static.akamaized.net/images/lol/champion/Diana.png?image=q_auto,w_34&amp;v=1576566284"
                                     alt="">다이애나
                            </td>
        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            <li class="nav-home">
                <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab"
                   aria-controls="pills-home" aria-selected="true">종합</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab"
                   aria-controls="pills-profile" aria-selected="false">아이템</a>
            </li>
            <li class="nav-skil">
                <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab"
                   aria-controls="pills-contact" aria-selected="false">스킬</a>
            </li>
            <li class="nav-Runes">
                <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact1" role="tab"
                   aria-controls="pills-contact" aria-selected="false">룬</a>
            </li>
            <li class="nav-tip">
                                ...
                                <td class="champion-overview__data">
                                    <ul class="champion-stats__list">
                                        <li class="champion-stats__list__item">
                                            <img src="//opgg-static.akamaized.net/images/lol/spell/SummonerSmite.png?image=q_auto,w_42&amp;v=1576566284"
                                        ...
                                        <li class="champion-stats__list__item">
                                            <img src="//opgg-static.akamaized.net/images/lol/spell/SummonerFlash.png?image=q_auto,w_42&amp;v=1576566284"
                                ...
                                <td class="champion-overview__data">
                                    <ul class="champion-stats__list">
                                        <li class="champion-stats__list__item tip"
                                            title="&lt;b style=&#039;color: #ffc659&#039;&gt;화약 역류&lt;/b&gt;
...
&lt;br&gt;&lt;br&gt;&lt;span&gt;화약을 흩뿌리는 탄환을 발사하여 직선상의 적에게 45/60/75/90/105&lt;scaleAD&gt;(+?)&lt;/scaleAD&gt;의 물리 피해를 입힙니다.&lt;br /&gt;&lt;br /&gt;화약 궤적은 2초 뒤, 지형에 충돌 시 0.2초 뒤 폭발하며 근처의 모든 적에게 85/120/155/190/225&lt;scaleAD&gt;(+?)&lt;/scaleAD&gt;의 물리 피해를 입힙니다.&lt;/span&gt;&lt;br&gt;&lt;br&gt;&lt;span style=&quot;font-size:11px; color: #ffc659;&quot;&gt;[?]로 표시된 값은 Riot API 에서 제공하지 않는 데이터입니다. 정확한 값은 LoL 클라이언트에서 확인 하실 수 있습니다.&lt;/span&gt;">
                                            <img src="//opgg-static.akamaized.net/images/lol/spell/GravesQLineSpell.png?image=q_auto,w_42&amp;v=1576566284"
                                                 alt=""> <span>Q</span>
                                        </li>
                                        ...
                                        <li class="champion-stats__list__item tip"
                                            title="&lt;b style=&#039;color: #ffc659&#039;&gt;빨리 뽑기&lt;/b&gt;
...
&lt;br&gt;&lt;br&gt;&lt;span&gt;한 방향으로 돌진하며 총탄을 하나 장전합니다. 또한 4초 동안 &lt;keywordMajor&gt;진정한 용기&lt;/keywordMajor&gt; 효과를 얻습니다. 적 챔피언을 향해 돌진할 경우에는 &lt;keywordMajor&gt;진정한 용기&lt;/keywordMajor&gt; 효과가 두 번 중첩됩니다.&lt;br /&gt;&lt;br /&gt;기본 공격이 적중할 때마다 빨리 뽑기 스킬의 재사용 대기시간이 0.5초씩 감소하고, 미니언이 아닌 대상에게 피해를 입힐 때마다 &lt;keywordMajor&gt;진정한 용기&lt;/keywordMajor&gt; 지속시간이 초기화됩니다.&lt;br /&gt;&lt;br /&gt;&lt;keywordMajor&gt;진정한 용기&lt;/keywordMajor&gt;가 활성화되면 방어력이 8/11/14/17/20 증가합니다. (회까지 중첩됩니다.)&lt;/span&gt;&lt;br&gt;&lt;br&gt;&lt;span style=&quot;font-size:11px; color: #ffc659;&quot;&gt;[?]로 표시된 값은 Riot API 에서 제공하지 않는 데이터입니다. 정확한 값은 LoL 클라이언트에서 확인 하실 수 있습니다.&lt;/span&gt;">
                                            <img src="//opgg-static.akamaized.net/images/lol/spell/GravesMove.png?image=q_auto,w_42&amp;v=1576566284"
                                                 alt=""> <span>E</span>
                                        </li>
                                        <li class="champion-stats__list__arrow">
                                            <img src="//opgg-static.akamaized.net/images/site/champion/blet.png" alt="">
                                        ...
                                        <li class="champion-stats__list__item tip"
                                            title="&lt;b style=&#039;color: #ffc659&#039;&gt;연막탄&lt;/b&gt;
...
&lt;br&gt;&lt;br&gt;&lt;span&gt;4초간 지속되는 검은 연기 구름을 만들어냅니다. 연기 속에 갇힌 적은 밖을 볼 수 없습니다.&lt;br /&gt;&lt;br /&gt;연막탄에 처음 맞은 적은 60/110/160/210/260 &lt;scaleAP&gt;(+60% 주문력)&lt;/scaleAP&gt;의 마법 피해를 입고 0.5초 동안 이동 속도가 50% 감소합니다.&lt;/span&gt;&lt;br&gt;&lt;br&gt;&lt;span style=&quot;font-size:11px; color: #ffc659;&quot;&gt;[?]로 표시된 값은 Riot API 에서 제공하지 않는 데이터입니다. 정확한 값은 LoL 클라이언트에서 확인 하실 수 있습니다.&lt;/span&gt;">
                                            <img src="//opgg-static.akamaized.net/images/lol/spell/GravesSmokeGrenade.png?image=q_auto,w_42&amp;v=1576566284"
                                                 alt=""> <span>W</span>
                                        </li>
                                    </ul>
                            ...
                            <tr class="champion-overview__row champion-overview__row--first">
                                ...
                                <td class="champion-overview__data champion-overview__border champion-overview__border--first">
                                    <ul class="champion-stats__list">
                                        ...
                                        <li class="champion-stats__list__arrow"></li>
                                        <li class="champion-stats__list__item tip"
                                            title="&lt;b style=&#039;color: #00cfbc&#039;&gt;충전형 물약&lt;/b&gt;&lt;br&gt;&lt;span&gt;일정 시간 동안 체력이 회복되며, 상점에 가면 다시 충전됩니다.&lt;/span&gt;&lt;br&gt;&lt;span&gt;&lt;groupLimit&gt;한 번에 한 종류의 회복 물약만 소지할 수 있습니다.&lt;/groupLimit&gt;&lt;br&gt;&lt;br&gt;&lt;active&gt;고유 사용 효과:&lt;/active&gt; 충전량을 1회 소모해 12초 동안 125의 체력을 회복합니다. 상점 방문 시 2회의 충전량이 다시 채워집니다.&lt;/span&gt;&lt;br&gt;&lt;span&gt;가격:&lt;/span&gt; &lt;span style=&#039;color: #ffc659&#039;&gt;150 (150)&lt;/span&gt;">
                        ...
                        <div class="tabWrap">
                            <table class="champion-overview__table champion-overview__table--rune tabItems">
                                ...
                                <tr>
                                    ...
                                    <th class="champion-overview__header">
                                        <a href="">
                                            <img src="https://img.icons8.com/nolan/30/info.png" alt="더보기"
                                ...
                                <tr>
                                    <th colspan="4">
                                        <div class="line-banner" style="display: none;">
                                            OP.GG Extension will automatically set up the runes below. <a
                                                href="https://chrome.google.com/webstore/detail/opgg-extension/gbipjohhadjcagjjjhcooalfnkdlnfim"
                                                target="_blank">[Download OP.GG Extension]</a>
                                        </div>
                                            ...
                                            <div class="perk-page">
                                                <div class="perk-page__row">
                                                    <div class="perk-page__item perk-page__item--mark">
                                                        <img src="//opgg-static.akamaized.net/images/lol/perkStyle/8000.png?image=q_auto&amp;v=1576566284"
                                                ...
                                                <div class="perk-page__row">
                                                    <div class="perk-page__item perk-page__item--keystone ">
                                                        <div class="perk-page__image">
                                                            <img src="//opgg-static.akamaized.net/images/lol/perk/8005.png?image=q_auto,e_grayscale&amp;v=1"
                                                                 class="tip"
                                                    ...
                                                    <div class="perk-page__item perk-page__item--keystone ">
                                                        <div class="perk-page__image">
                                                            <img src="//opgg-static.akamaized.net/images/lol/perk/8008.png?image=q_auto,e_grayscale&amp;v=1"
                                                                 class="tip"
                                                    ...
                                                    <div class="perk-page__item perk-page__item--keystone perk-page__item--active">
                                                        <div class="perk-page__image">
                                                            <img src="//opgg-static.akamaized.net/images/lol/perk/8021.png?image=q_auto&amp;v=1576566284"
                                                                 class="tip"
                                                    ...
                                                    <div class="perk-page__item perk-page__item--keystone ">
                                                        <div class="perk-page__image">
                                                            <img src="//opgg-static.akamaized.net/images/lol/perk/8010.png?image=q_auto,e_grayscale&amp;v=1"
                                                                 class="tip"
                                                ...
                                                <div class="perk-page__row">
                                                    <div class="perk-page__item  ">
                                                        <div class="perk-page__image">
                                                            <img src="//opgg-static.akamaized.net/images/lol/perk/9101.png?image=q_auto,e_grayscale&amp;v=1"
                                                                 class="tip"
                                                    ...
                                                    <div class="perk-page__item  perk-page__item--active">
                                                        <div class="perk-page__image">
                                                            <img src="//opgg-static.akamaized.net/images/lol/perk/9111.png?image=q_auto&amp;v=1576566284"
                                                                 class="tip"
                                                    ...
                                                    <div class="perk-page__item  ">
                                                        <div class="perk-page__image">
                                                            <img src="//opgg-static.akamaized.net/images/lol/perk/8009.png?image=q_auto,e_grayscale&amp;v=1"
                                                                 class="tip"
                                                ...
                                                <div class="perk-page__row">
                                                    <div class="perk-page__item  perk-page__item--active">
                                                        <div class="perk-page__image">
                                                            <img src="//opgg-static.akamaized.net/images/lol/perk/9104.png?image=q_auto&amp;v=1576566284"
                                                                 class="tip"
                                                    ...
                                                    <div class="perk-page__item  ">
                                                        <div class="perk-page__image">
                                                            <img src="//opgg-static.akamaized.net/images/lol/perk/9105.png?image=q_auto,e_grayscale&amp;v=1"
                                                                 class="tip"
                                                    ...
                                                    <div class="perk-page__item  ">
                                                        <div class="perk-page__image">
                                                            <img src="//opgg-static.akamaized.net/images/lol/perk/9103.png?image=q_auto,e_grayscale&amp;v=1"
                                                                 class="tip"
                                                ...
                                                <div class="perk-page__row">
                                                    <div class="perk-page__item  perk-page__item--active">
                                                        <div class="perk-page__image">
                                                            <img src="//opgg-static.akamaized.net/images/lol/perk/8014.png?image=q_auto&amp;v=1576566284"
                                                                 class="tip"
                                                    ...
                                                    <div class="perk-page__item  ">
                                                        <div class="perk-page__image">
                                                            <img src="//opgg-static.akamaized.net/images/lol/perk/8017.png?image=q_auto,e_grayscale&amp;v=1"
                                                                 class="tip"
                                                    ...
                                                    <div class="perk-page__item  ">
                                                        <div class="perk-page__image">
                                                            <img src="//opgg-static.akamaized.net/images/lol/perk/8299.png?image=q_auto,e_grayscale&amp;v=1"
                                                                 class="tip"
...
<%--                                            결의 --%>
                                        ...
                                        <%-- 지배 --%>
                                            <div class="perk-page">
                                                <div class="perk-page__row">
                                                    <div class="perk-page__item perk-page__item--mark">
                                                        <img src="//opgg-static.akamaized.net/images/lol/perkStyle/8100.png?image=q_auto&amp;v=1576566284"
                                                             class="perk-page__image tip"
                                                ...
                                                <div class="perk-page__row">
                                                    <div class="perk-page__item ">
                                                        <div class="perk-page__image">
                                                            <img src="//opgg-static.akamaized.net/images/lol/perk/8126.png?image=q_auto,e_grayscale&amp;v=1"
                                                                 class="tip"
                                                    ...
                                                    <div class="perk-page__item ">
                                                        <div class="perk-page__image">
                                                            <img src="//opgg-static.akamaized.net/images/lol/perk/8139.png?image=q_auto,e_grayscale&amp;v=1"
                                                                 class="tip"
                                                    ...
                                                    <div class="perk-page__item perk-page__item--active">
                                                        <div class="perk-page__image">
                                                            <img src="//opgg-static.akamaized.net/images/lol/perk/8143.png?image=q_auto&amp;v=1576566284"
                                                                 class="tip"
                                                ...
                                                <div class="perk-page__row">
                                                    <div class="perk-page__item ">
                                                        <div class="perk-page__image">
                                                            <img src="//opgg-static.akamaized.net/images/lol/perk/8136.png?image=q_auto,e_grayscale&amp;v=1"
                                                                 class="tip"
                                                    ...
                                                    <div class="perk-page__item ">
                                                        <div class="perk-page__image">
                                                            <img src="//opgg-static.akamaized.net/images/lol/perk/8120.png?image=q_auto,e_grayscale&amp;v=1"
                                                                 class="tip"
                                                    ...
                                                    <div class="perk-page__item ">
                                                        <div class="perk-page__image">
                                                            <img src="//opgg-static.akamaized.net/images/lol/perk/8138.png?image=q_auto,e_grayscale&amp;v=1"
                                                                 class="tip"
                                                ...
                                                <div class="perk-page__row">
                                                    <div class="perk-page__item ">
                                                        <div class="perk-page__image">
                                                            <img src="//opgg-static.akamaized.net/images/lol/perk/8135.png?image=q_auto,e_grayscale&amp;v=1"
                                                                 class="tip"
                                                    ...
                                                    <div class="perk-page__item ">
                                                        <div class="perk-page__image">
                                                            <img src="//opgg-static.akamaized.net/images/lol/perk/8134.png?image=q_auto,e_grayscale&amp;v=1"
                                                                 class="tip"
                                                    ...
                                                    <div class="perk-page__item perk-page__item--active">
                                                        <div class="perk-page__image">
                                                            <img src="//opgg-static.akamaized.net/images/lol/perk/8105.png?image=q_auto&amp;v=1576566284"
                                                                 class="tip"
                                                    ...
                                                    <div class="perk-page__item ">
                                                        <div class="perk-page__image">
                                                            <img src="//opgg-static.akamaized.net/images/lol/perk/8106.png?image=q_auto,e_grayscale&amp;v=1"
                                                                 class="tip"
                                            ...
                                            <div class="fragment-page">
                                                <div class="fragment__detail">
                                                    <div class="fragment__row">
                                                        <div class="fragment">
                                                            <div class="perk-page__image">
                                                                <img src="//opgg-static.akamaized.net/images/lol/perkShard/5008.png?image=q_auto,e_grayscale&amp;v=1"
                                                                     class="tip"
                                                        ...
                                                        <div class="fragment">
                                                            <div class="perk-page__image">
                                                                <img src="//opgg-static.akamaized.net/images/lol/perkShard/5005.png?image=q_auto&amp;v=1576566284"
                                                                     class="active tip"
                                                        ...
                                                        <div class="fragment">
                                                            <div class="perk-page__image">
                                                                <img src="//opgg-static.akamaized.net/images/lol/perkShard/5007.png?image=q_auto,e_grayscale&amp;v=1"
                                                                     class="tip"
                                                    ...
                                                    <div class="fragment__row">
                                                        <div class="fragment">
                                                            <div class="perk-page__image">
                                                                <img src="//opgg-static.akamaized.net/images/lol/perkShard/5008.png?image=q_auto&amp;v=1576566284"
                                                                     class="active tip"
                                                                     title="&lt;b style=&#039;color: #ffc659&#039;&gt;OFFENSE&lt;/b&gt;&lt;br&gt;&lt;span&gt;적응형 능력치 +9&lt;/span&gt;"
                                                                     alt="OFFENSE">
                                                            </div>
                                                        ...
                                                        <div class="fragment">
                                                            <div class="perk-page__image">
                                                                <img src="//opgg-static.akamaized.net/images/lol/perkShard/5002.png?image=q_auto,e_grayscale&amp;v=1"
                                                                     class="tip"
                                                        ...
                                                        <div class="fragment">
                                                            <div class="perk-page__image">
                                                                <img src="//opgg-static.akamaized.net/images/lol/perkShard/5003.png?image=q_auto,e_grayscale&amp;v=1"
                                                                     class="tip"
                                                    ...
                                                    <div class="fragment__row">
                                                        <div class="fragment">
                                                            <div class="perk-page__image">
                                                                <img src="//opgg-static.akamaized.net/images/lol/perkShard/5001.png?image=q_auto,e_grayscale&amp;v=1"
                                                                     class="tip"
                                                        ...
                                                        <div class="fragment">
                                                            <div class="perk-page__image">
                                                                <img src="//opgg-static.akamaized.net/images/lol/perkShard/5002.png?image=q_auto&amp;v=1576566284"
                                                                     class="active tip"
                                                                     title="&lt;b style=&#039;color: #ffc659&#039;&gt;FLEX&lt;/b&gt;&lt;br&gt;&lt;span&gt;방어력 +6&lt;/span&gt;"
                                                                     alt="FLEX">
                                                            </div>
                            ...
                            <div class="champion-box-header">
                                ...
                                <div class="champion-box-header__more">
                                    <a href="/champion/graves/jungle/comment" class="champion-box-header__link">
                                        <img src="https://img.icons8.com/nolan/40/info.png" alt="더보기"
            ...
            <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                ...
                <div id="container" class="itemList">
                    ...
                    <ul>
                        <li><img
                                src="http://static.inven.co.kr/image_2011/site_image/lol/dataninfo/icon/item/3850.png?v=20191212a"
                                onmouseover="LOL.Db.ItemLayer.show('506');" onmouseout="LOL.Db.ItemLayer.hide('506');">
                        </li>
                        <li><img
                                src="http://static.inven.co.kr/image_2011/site_image/lol/dataninfo/icon/item/2003.png?v=20191212a"
                                onmouseover="LOL.Db.ItemLayer.show('43');" onmouseout="LOL.Db.ItemLayer.hide('43');">
                        </li>
                        <li><img
                                src="http://static.inven.co.kr/image_2011/site_image/lol/dataninfo/icon/item/2003.png?v=20191212a"
                                onmouseover="LOL.Db.ItemLayer.show('43');" onmouseout="LOL.Db.ItemLayer.hide('43');">
                        ...
                        <li><img
                                src="http://static.inven.co.kr/image_2011/site_image/lol/dataninfo/icon/item/3364.png?v=20191212a"
                                onmouseover="LOL.Db.ItemLayer.show('238');" onmouseout="LOL.Db.ItemLayer.hide('238');">
                        </li>
                    </ul>
                    ...
                    <ul>
                        <li><img
                                src="http://static.inven.co.kr/image_2011/site_image/lol/dataninfo/icon/item/3285.png?v=20191212a"
                                onmouseover="LOL.Db.ItemLayer.show('311');" onmouseout="LOL.Db.ItemLayer.hide('311');">
                        </li>
                        <li><img
                                src="http://static.inven.co.kr/image_2011/site_image/lol/dataninfo/icon/item/3151.png?v=20191212a"
                                onmouseover="LOL.Db.ItemLayer.show('175');" onmouseout="LOL.Db.ItemLayer.hide('175');">
                        </li>
                        <li><img
                                src="http://static.inven.co.kr/image_2011/site_image/lol/dataninfo/icon/item/3020.png?v=20191212a"
                                onmouseover="LOL.Db.ItemLayer.show('89');" onmouseout="LOL.Db.ItemLayer.hide('89');">
                        </li>
                        <li><img
                                src="http://static.inven.co.kr/image_2011/site_image/lol/dataninfo/icon/item/3853.png?v=20191212a"
                                onmouseover="LOL.Db.ItemLayer.show('508');" onmouseout="LOL.Db.ItemLayer.hide('508');">
                        </li>
                        <li><img
                                src="http://static.inven.co.kr/image_2011/site_image/lol/dataninfo/icon/item/1004.png?v=20191212a"
                                onmouseover="LOL.Db.ItemLayer.show('33');" onmouseout="LOL.Db.ItemLayer.hide('33');">
                        </li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li><img
                                src="http://static.inven.co.kr/image_2011/site_image/lol/dataninfo/icon/item/3157.png?v=20191212a"
                                onmouseover="LOL.Db.ItemLayer.show('114');" onmouseout="LOL.Db.ItemLayer.hide('114');">
                        </li>
                        <li><img
                                src="http://static.inven.co.kr/image_2011/site_image/lol/dataninfo/icon/item/3089.png?v=20191212a"
                                onmouseover="LOL.Db.ItemLayer.show('77');" onmouseout="LOL.Db.ItemLayer.hide('77');">
                        </li>
                    </ul>
                    ...
                    <div class="itemBuild">
                        <ul>
                            <li><img
                                    src="http://static.inven.co.kr/image_2011/site_image/lol/dataninfo/icon/item/3850.png?v=20191212a"
                                    onmouseover="LOL.Db.ItemLayer.show('506');"
                                    onmouseout="LOL.Db.ItemLayer.hide('506');"></li>
                            <li><img
                                    src="http://static.inven.co.kr/image_2011/site_image/lol/dataninfo/icon/item/1052.png?v=20191212a"
                                    onmouseover="LOL.Db.ItemLayer.show('3');" onmouseout="LOL.Db.ItemLayer.hide('3');">
                            </li>
                            <li><img
                                    src="http://static.inven.co.kr/image_2011/site_image/lol/dataninfo/icon/item/3802.png?v=20191212a"
                                    onmouseover="LOL.Db.ItemLayer.show('378');"
                                    onmouseout="LOL.Db.ItemLayer.hide('378');"></li>
                            <li><img
                                    src="http://static.inven.co.kr/image_2011/site_image/lol/dataninfo/icon/item/2422.png?v=20191212a"
                                    onmouseover="LOL.Db.ItemLayer.show('433');"
                                    onmouseout="LOL.Db.ItemLayer.hide('433');"></li>
                            <li><img
                                    src="http://static.inven.co.kr/image_2011/site_image/lol/dataninfo/icon/item/3020.png?v=20191212a"
                                    onmouseover="LOL.Db.ItemLayer.show('89');"
                                    onmouseout="LOL.Db.ItemLayer.hide('89');"></li>
                            <li><img
                                    src="http://static.inven.co.kr/image_2011/site_image/lol/dataninfo/icon/item/3285.png?v=20191212a"
                                    onmouseover="LOL.Db.ItemLayer.show('311');"
                                    onmouseout="LOL.Db.ItemLayer.hide('311');"></li>
                            <li><img
                                    src="http://static.inven.co.kr/image_2011/site_image/lol/dataninfo/icon/item/1026.png?v=20191212a"
                                    onmouseover="LOL.Db.ItemLayer.show('12');"
                                    onmouseout="LOL.Db.ItemLayer.hide('12');"></li>
                            <li><img
                                    src="http://static.inven.co.kr/image_2011/site_image/lol/dataninfo/icon/item/3136.png?v=20191212a"
                                    onmouseover="LOL.Db.ItemLayer.show('42');"
                                    onmouseout="LOL.Db.ItemLayer.hide('42');"></li>
                            <li><img
                                    src="http://static.inven.co.kr/image_2011/site_image/lol/dataninfo/icon/item/3151.png?v=20191212a"
                                    onmouseover="LOL.Db.ItemLayer.show('175');"
                                    onmouseout="LOL.Db.ItemLayer.hide('175');"></li>
                        </ul>
                        <div class="arrow_enter"></div>
                        <ul>
                            <li><img
                                    src="http://static.inven.co.kr/image_2011/site_image/lol/dataninfo/icon/item/3108.png?v=20191212a"
                                    onmouseover="LOL.Db.ItemLayer.show('34');"
                                    onmouseout="LOL.Db.ItemLayer.hide('34');"></li>
                            <li><img
                                    src="http://static.inven.co.kr/image_2011/site_image/lol/dataninfo/icon/item/3102.png?v=20191212a"
                                    onmouseover="LOL.Db.ItemLayer.show('8');" onmouseout="LOL.Db.ItemLayer.hide('8');">
                            </li>
                            <li><img
                                    src="http://static.inven.co.kr/image_2011/site_image/lol/dataninfo/icon/item/3157.png?v=20191212a"
                                    onmouseover="LOL.Db.ItemLayer.show('114');"
                                    onmouseout="LOL.Db.ItemLayer.hide('114');"></li>
                            <li><img
                                    src="http://static.inven.co.kr/image_2011/site_image/lol/dataninfo/icon/item/3165.png?v=20191212a"
                                    onmouseover="LOL.Db.ItemLayer.show('176');"
                                    onmouseout="LOL.Db.ItemLayer.hide('176');"></li>
                            <li class="last"><img
                                    src="http://static.inven.co.kr/image_2011/site_image/lol/dataninfo/icon/item/3089.png?v=20191212a"
                                    onmouseover="LOL.Db.ItemLayer.show('77');"
                                    onmouseout="LOL.Db.ItemLayer.hide('77');"></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="tab-pane fade" id="pills-contact2" role="tabpanel" aria-labelledby="pills-contact-tab">
                ...
                <form method="get" action="tipboard.do" class="" style="top-margin:3em;">
                    <c:if test="${!empty member }">
                        <div class="button-1">
                            <div class="eff-1"></div>
                            <a class="btnsuccess" data-toggle="modal" href="#registerModal" id="btn"
                               style="display: block;">글쓰기</a></div>
                    </c:if>
                    <c:if test="${empty member }">
                        <a class="btnsuccess" style="display:none; position: relative; left: 880px;" data-toggle="modal"
                           href="#registerModal" id="btn-add">글쓰기</a>
                    </c:if>
                </form>
                        ...
                        <div class="modal-content" style="width: 120%; border: 4px solid rgba(0, 0, 0, 0.2); ">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="champion-stats-comment-write">
                                    <form name="tipBoard"
                                          action="${pageContext.request.contextPath}/champion/tipBoard.do"
                                          method="post">
                                        <input type="text" name="tipTitle" class="form-control" placeholder="제목을 입력해주세요"
                                               maxlength="20">
                                        <hr/>
                                        <input type="hidden" name="championName" class="form-control"
                                               value="${champion.name}"/>
                                        <textarea class="champion-stats-comment-write__textarea"
                                                  placeholder="이 챔피언에 대한 간단한 팁을 남겨주세요.&#13;&#10;챔피언 팁이 아닌 악성 댓글은 삭제처리됩니다."
                                                  name="tipContent"
                                                  style="overflow: hidden; overflow-wrap: break-word; height: 50px; width:80%; max;"></textarea>
                                        <div class="champion-stats-comment-write__footer">
                                            <center>
                                                <div class="champion-stats-comment-write__patch">★유저들에게 좋은 정보를 공유해주세요★
                                                </div>
                                            </center>
