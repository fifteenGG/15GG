...
<div class="container-fluid gg-text-normal">
	<!-- 두오 신청 등록 -->
	<form class="needs-validation col-12 px-0 mb-0" autocomplete="off" novalidate="" action="partyBoardInsert.do" onsubmit="return check();">
		<div class="row gg-division">
			...
			<div class="col-12 col-lg-8">
				<div class="row gg-box">
					...
					<div class="col-12 col-lg-6 px-0">
						<div class="btn-group bootstrap-select form-control my-0">
							<select name="pbRanktype" class="form-control selectpicker my-0" data-style="btn btn-link gg-select" id="pbRanktype" tabindex="-98">
					...
					<div class="col-12 col-lg-6 px-0">
						<div class="btn-group bootstrap-select form-control my-0">
							<select name="pbTier" class="form-control selectpicker my-0" data-style="btn btn-link gg-select" id="pbTier" tabindex="-98">

								<option value="티어 상관없이">티어 상관없이</option>
								<option value="언랭 이상">언랭 이상</option>
								<option value="아이언 이상">아이언 이상</option>
								<option value="브론즈 이상">브론즈 이상</option>
								<option value="실버 이상">실버 이상</option>
								<option value="골드 이상">골드 이상</option>
								<option value="플레 이상">플레 이상</option>
								<option value="다이아 이상">다이아 이상</option>
								<option value="마스터 이상">마스터 이상</option>
								<option value="그마 이상">그마 이상</option>
					...
					<div class="col-12 col-lg-5 px-0">
						<div class="btn-group bootstrap-select form-control my-0">
							<select name="pbPosition" class="form-control selectpicker my-0" data-style="btn btn-link gg-select" id="pbPosition" tabindex="-98">
					...
					<div class="col-12 col-lg-5 px-0">
						<div class="btn-group bootstrap-select form-control my-0">
							<select name="pbTimer" class="form-control selectpicker my-0" data-style="btn btn-link gg-select" id="pbTimer" tabindex="-98">
					...
					<!-- 보이스 버튼 -->
					<div class="col-12 col-lg-2 px-0 d-flex align-items-center justify-content-end">
						<div class="togglebutton mt-2">
							<label class="mb-0">
								<span class="d-inline gg-text-form"><i class="fas fa-microphone-slash" style="color: #007bff;"></i></span>
								<input name="pbVoice" id="pbVoice" type="checkbox" value="Y">
								<span class="toggle mr-0"></span> &nbsp;&nbsp;
								<span class="d-inline gg-text-form"><i class="fas fa-microphone" style="color: #007bff;"></i></span>
							</label>
						</div>
					</div>
                ...
                <span class="bmd-form-group"><div class="input-group">
                    <input name="pbUser" id="pbUser" type="text" value="" class="form-control border-0" placeholder="소환사명">
                </div></span>
					</div>
					<div class="col-12 px-0">
                <span class="bmd-form-group"><div class="input-group">
                   <input name="pbContent" class="form-control" id="pbContent" maxlength="200" rows="2" placeholder="200자 이내 내용">
                </div></span>
					</div>
	...
	<div class="row gg-division">
		...
		<div class="col-12 col-lg-8">
			<div class="row gg-box">
				...
				<!-- 검색 동작 폼 -->
				<form class= "col-12 px-0 d-flex flex-wrap flex-lg-nowrap align-items-center" action="${pageContext.request.contextPath}/partyBoard/searchList.do">
					<div class="col-12 px-0 d-flex flex-wrap flex-lg-nowrap align-items-center">
						...
						<div class="btn-group bootstrap-select form-control my-0">
							<select name="pbTier" class="form-control selectpicker my-0" data-style="btn btn-link gg-select" id="duoRequestListTierSelect" tabindex="-98">
						...
						<div class="btn-group bootstrap-select form-control my-0">
							<select name="pbPosition" class="form-control selectpicker my-0" data-style="btn btn-link gg-select" id="duoRequestListLaneSelect" tabindex="-98">
						...
						<button id="search" type="submit" class="btn btn-info btn-sm rounded-0" >검색 </button>
					</div>
				</form>

				<div id="content" class="col-12 collapse" style="display: block;">
					<div class="col-12 px-0 mb-4 bg-white d-flex justify-content-end">
						<!--  <button id="search" class="btn btn-info btn-sm rounded-0" onclick="search();">검색 </button> -->
						<!-- 검색키워드 input필요 form action=list로 주고  method는 get으로
                            input type은 text?? -->
					</div>
   ...
   <span id="cancelline${status.index }">
      <div class="d-flex flex-column w-100 gg-action p-2 listView" id="listView" data-event="DuoRequestProfile" data-href="/kr/profile/2417">
         <div class="d-flex align-items-center gg-duo-request-list-title">
            ...
            <div class="d-flex align-items-center">${list.pbPosition}<div></div></div>

			 <!-- 마이크 on/off 표시 -->
         <div class="px-1">
            <c:choose>
				<c:when test="${list.pbVoice eq ''}">
					<i class="fas fa-microphone-slash" style="color: #007bff;"></i>
				</c:when>
				<c:otherwise>
		  ...
		  <!-- 내용 입력 -->
        <div class="d-flex gg-duo-request-text text-secondary text-left py-2">${list.pbContent}</div>
           <div class="d-flex gg-text-large justify-content-end pt-2">
<!-- 유저 아이콘 -->
            <div><i class="fas fa-users"></i><span class="gg-text-normal-color">${list.pbUser} </span></div>
                <div class="px-2"></div>
			   <!-- 스톱워치 아이콘 -->
			   <!-- 남은시간 알려줌 -->
            <div><i class="fas fa-stopwatch"></i><span id="stopwatch${status.index }"></span></div>
         </div>
		  <!-- 경과시간 보여줌 -->
              <div class="d-flex justify-content-end gg-sub-description"><i class="fas fa-history"></i><span id="aftertime${status.index}"></span></div>
							...
							$(document).ready(function(){
								...
								$("#duoRequestMoreBtn").on("click", function(e){
									...
									if($("span[id*=list]:hidden").length == 0) {
										$("#duoRequestMoreBtn").text("ㄷ...더이상..보여줄게 없어").addClass("noContent");
									}
								});
							});
