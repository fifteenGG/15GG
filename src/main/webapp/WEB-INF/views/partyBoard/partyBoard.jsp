    ...
    <form class="needs-validation col-12 px-0 mb-0" autocomplete="off" novalidate="" action="partyBoardInsert.do" onsubmit="return check();">
		...
		<div class="col-12 col-lg-5 px-0">
			...
			<c:otherwise>
				<div class="col-12 px-0 mt-3">
                <span class="bmd-form-group"><div class="input-group">
                    <input name="pbUser" id="pbUser" type="text" value="${member.nickName}" class="form-control border-0" readonly>
                </div></span>
            </div>
			</c:otherwise>
...
<form class= "col-12 px-0 d-flex flex-wrap flex-lg-nowrap align-items-center" action="${pageContext.request.contextPath}/partyBoard/searchList.do">
		...
		<div class="btn-group bootstrap-select form-control my-0">
			<select name="pbTier" class="form-control selectpicker my-0" data-style="btn btn-link gg-select" id="duoRequestListTierSelect" tabindex="-98">
				...
				<option value="실버 이상">실버</option>
				<option value="골드 이상">골드</option>
				<option value="플레 이상">플레티넘</option>
