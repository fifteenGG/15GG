...
<div class="gg-matchlist-box gg-division" style="width:600px; height:450px;"><canvas id="myChart"></canvas>
...
<div class="gg-matchlist-box gg-division" style="width:600px; height:450px;"><canvas id="lineChart"></canvas>
<div class="col-4 px-2 d-flex flex-column justify-content-center">
        <span class="gg-important-number gg-text-positive">55%</span>
        <span class="gg-sub-description">11W 9L</span>
        <span class="gg-line"></span>
	...
	var chart = new Chart(ctx, {
	    ...
	    data: {
	        ...
	        datasets: [{
	            ...
	            backgroundColor: ['rgb(255, 99, 132)','rgb(25, 59, 12)'],
